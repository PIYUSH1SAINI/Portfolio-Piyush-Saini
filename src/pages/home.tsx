...
function TopSection() {
  return (
    ...
    >
      ...
      <Para>
        Code that clicks, design that sticks — I ship products fast, with a bag
        of tricks.
        ...
        >
          <Section header="Me">
            <div className="flex flex-col gap-4 sm:border sm:p-4 sm:rounded sm:hover:border-accent-foreground sm:hover:cursor-pointer">
              <Para>
                I'm always up for <Highlight>new ideas</Highlight> — whether
                it’s experimenting with fresh technologies or building tools
                that make <Highlight>developers’ lives easier</Highlight>.
              </Para>
              <Para>
                I love the <Highlight>learning curve</Highlight> that comes with
                taking on new challenges. It pushes me to grow not just as a
                developer, but as a problem-solver and creator.
              </Para>
              <Para>
                I even started an <Highlight>agency of my own</Highlight> (even
                though it failed) because I enjoy the mix of{" "}
                <Highlight>innovation, collaboration, and growth</Highlight> it
                brings.
              </Para>
            </div>
          </Section>
          ...
          <Section header="Connect">
            <div className="flex flex-col gap-4">
              <div className="flex gap-4 flex-wrap">
                <OuterLink
                  to="https://www.linkedin.com/in/saini-piyush/"
                  className="text-primary hover:text-accent-foreground"
                  inline
                >
                  LinkedIn
